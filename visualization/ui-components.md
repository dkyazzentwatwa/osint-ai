...
Reusable UI elements for OSINT Investigator text-based interface.
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│  OSINT INVESTIGATOR v2.0  │  Case: PHOENIX  │  Status: ACTIVE  │  14:32:18 │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│                                                                              │
│  LINK:                                                                       │
│  \033[4m\033[34mView full report: https://example.com/report/12345\033[0m                          │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
*Version: 2.0 | Components: 50+ | Last Updated: 2026-02-27*
